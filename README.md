...
- **Grade-specific trick banner** — Mental math tricks that update based on selected class and streaks.

### 🏆 Gamified Learning
- Score points, build answer streaks, collect stars, and celebrate with sound effects and confetti!

---

## 🚀 Run Locally

No dependencies required! Just clone and open `index.html` in any browser:

```bash
git clone https://github.com/mmbavliya/basic-math-game.git
cd basic-math-game
...
## 📄 License
Free to use for students, parents, and teachers. Made with ❤️ for young learners.
